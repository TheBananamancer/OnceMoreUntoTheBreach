...
3.  Present the first scenario. (Implemented)
4.  Get player's choice. (Implemented in FirstScenario)
5.  Process the choice and display the outcome. (Implemented in FirstScenario)
6.  Present the second scenario. (Implemented)
